...
namespace SMS_API.Controllers
{
    ...
    public class AttendanceController : ControllerBase
    {
        ...
        [HttpPatch("{id}")]
        public async Task<IActionResult> UpdateAttendancePatch([FromRoute] long id, [FromBody] JsonPatchDocument cModel)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteAttendance([FromRoute] long id)
        {
