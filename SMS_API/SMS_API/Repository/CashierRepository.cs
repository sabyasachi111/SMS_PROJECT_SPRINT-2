...
namespace SMS_API.Repository
{
    public class CashierRepository : ICashierRepository
    {
        ...
        public async Task<CashierModel> GetCashierByIdAsync(long Id)
        {
        ...
        public async Task UpdateCashierPatchAsync(long Id, JsonPatchDocument cModel)
        {
        ...
        public async Task DeleteCashierAsync(long Id)
        {
